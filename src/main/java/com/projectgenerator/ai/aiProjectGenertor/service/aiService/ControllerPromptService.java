...
public class ControllerPromptService {
    ...
    public String generateControllerCode(ProjectDetailsModel projectDetailsModel){
        StringBuilder prompt = getPrompt(projectDetailsModel);
    ...
    private StringBuilder getPrompt(ProjectDetailsModel projectDetailsModel){
